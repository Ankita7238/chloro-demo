    ...
    <section className="w-full pb-24 md:px-8 px-0 flex md:flex-row flex-col-reverse justify-center items-center">
      ...
      <div className="relative w-4/5 lg:1/2 flex justify-center md:justify-end items-center mt-5 ">
        <div className='w-4/5 md:w-full xl:w-4/5 relative flex justify-center md:justify-end items-center '>
          <PictureContainer
            src='https://res.cloudinary.com/dlvuryigq/image/upload/v1729478495/woman-taking-a-bath-massage-soap-treat-yourself-sp-ZZG446W-2_zwhqs7.jpg'
            alt='blog image 2'
            className='w-full pb-[110%] xl:pb-[90%]'
          />
      ...
      <div className=" w-full md:w-1/2 lg:w-[50%] text-white flex flex-col items-center justify-center gap-y-6 ">
        <div className='w-full bg-[#023A15] flex flex-col gap-y-2 lg:gap-y-5 text-white p-[4%] lg:p-[8%] black shadow-lg relative left-0 md:-left-10 top-2/3 overflow-x-clip '>
          ...
          <p className={`${montserrat.className} text-sm lg:text-lg mb-5 text-center md:text-left`}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur lobortis erat posuere, tincidunt sem at, sagittis dolor.
          </p>
        ...
        {/* CountUp section with Intersection Observer */}
        <div ref={ref} className="text-center gap-x-16 gap-y-8 text-[#0a5738] flex flex-col lg:flex-row md:self-start self-center font-semibold mx-auto lg:mx-0 w-fit">
          <div>
            <p className={`${cormorant.className} text-3xl lg:text-5xl text-[#023A15]`}>
              {inView && <CountUp start={300} end={955} duration={2} />}+
            </p>
            <p className={`${montserrat.className} text-sm font-extrabold text-[#0a5738]`}>Happy Customers</p>
          </div>
          <div>
            <p className={`${cormorant.className} text-3xl lg:text-5xl text-[#023A15]`}>
              {inView && <CountUp start={100} end={240} duration={2} />}+
            </p>
